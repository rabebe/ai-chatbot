    ...
    while True:
        try:
            ...
            if user_input.lower() == 'info':
                ...
                print(f"  Directory: {info.get('persist_directory', 'Unknown')}")
                continue
            ...
            if command == 'summarize':
                if not query:
                    print("Please provide a query to summarize. Example: summarize machine learning basics")
                    continue
                ...
                if not query:
                    print("Please provide a question. Example: ask What is machine learning?")
                    continue
                ...
                if not query:
                    print("Please provide a search query. Example: search machine learning")
                    continue
...
def main():
    ...
    parser.add_argument("--question", type=str, help="Question to answer (for CLI mode)")
    parser.add_argument("--files", nargs="+", help="Specific files to load")
    parser.add_argument("--embedding-model", choices=["huggingface"], default="huggingface",
                       help="Embedding model to use")
    parser.add_argument("--llm-model", choices=["google"], default="google",
    ...
    try:
        ...
        if args.mode == "interactive":
            ...
            # CLI mode
            if args.query:
                print(f"Summarizing: {args.query}")
